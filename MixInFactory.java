/*
  http://www.javassist.org/html/javassist/util/proxy/ProxyFactory.html
  https://www.beyondjava.net/javassist-implement-mixins-traits-java
*/

public class MixInFactory<T> {

   @SuppressWarnings("unchecked")
   public T create(Class<T> iface, Class<?>... mixinClasses) 
      ...
      try {
         objectWithMixins = (T) factory.create(new Class<?>[0], 
...
class MixinHandler<T> implements MethodHandler {
   ...
   MixinHandler(Class<T> iface, Class<?>... mixinClasses) 
                throws ReflectiveOperationException  {
